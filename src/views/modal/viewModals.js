            ...
            <section class="body-modal">
                <form action="#" class="form" id="form-create-post">
                    ...
                    <section class="reaction-post-group">
                        ...
                        <img src="../src/assets/images/svg/carita.png" class="smile" alt="icon-face" width="20" height="20">
                    </section>
...
const loadViewModals = () => {
    loadViewModalForm();
    loadViewModalDelete();
}
export { loadViewModals }